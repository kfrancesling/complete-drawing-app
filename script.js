...
function setup() {
  	createCanvas(window.innerWidth, window.innerHeight); // this creates the canvas we will work upon, the window functions delcare 
  	background(255); // this is the background colour in rgb 
}
